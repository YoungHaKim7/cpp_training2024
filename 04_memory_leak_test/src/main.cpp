...
// linux build command
// g++ -ggdb -fsanitize=address -fno-omit-frame-pointer -static-libstdc++
// -static-libgcc -static-libasan -lrt memory_leak.cpp g++ -ggdb -fsanitize=leak
// -fno-omit-frame-pointer -static-libstdc++ -static-libgcc -static-liblsan -lrt
// memory_leak.cpp
//
// mac osx build command
// g++ -ggdb -fsanitize=address -fno-omit-frame-pointer -static-libstdc++
// -static-libgcc memory_leak.cpp g++ -ggdb -fsanitize=leak
// -fno-omit-frame-pointer -static-libstdc++ -static-libgcc memory_leak.cpp
